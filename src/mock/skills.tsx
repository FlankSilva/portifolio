...
export const skills = ({ size }: SkillsProps) => [
  ...
  {
    title: 'REACT NATIVE',
    description: 'Arquitetura, navegação, armazenamento local, push notifications, offline first, geolocalização',
    icon: <ReactNativeIcon size={size} />,
    url: 'https://reactnative.dev',
  },
  {
    title: 'TYPESCRIPT',
    description: 'Tipagem estática, interfaces, generics, integração com React/Node',
    icon: <TypeScriptIcon size={size} />,
    url: 'https://www.typescriptlang.org',
  },
  {
    title: 'TAILWIND CSS',
    description: 'Estilização utilitária, componentização, design system, dark mode',
  ...
  {
    title: 'CSS3',
    description: 'Estilização moderna, animações, flexbox, grid, responsividade',
  ...
  },
  {
    ...
    icon: <GenericIcon size={size} name="Express" />,
    url: 'https://expressjs.com',
  },
  {
    title: 'PHP / LARAVEL',
    description: 'MVC, rotas, Eloquent ORM, autenticação, views',
    icon: <GenericIcon size={size} name="Laravel" />,
    url: 'https://laravel.com',
  },
  {
    title: 'FIREBASE',
    description: 'Auth, Firestore, Storage, Cloud Functions',
    icon: <GenericIcon size={size} name="Firebase" />,
    url: 'https://firebase.google.com',
  },
  {
    title: 'API INTEGRATION',
    description: 'Consumo, autenticação JWT, axios/fetch, uploads/downloads',
    icon: <GenericIcon size={size} name="API" />,
    url: 'https://developer.mozilla.org/pt-BR/docs/Web/API',
  },
  {
    title: 'JWT / SEGURANÇA',
    description: 'Autenticação JWT, controle de sessão, cookies, CORS',
    icon: <GenericIcon size={size} name="JWT" />,
    url: 'https://jwt.io',
  },
  // 🗄️ Banco de Dados
  {
  ...
  },
  {
    ...
    icon: <GenericIcon size={size} name="SQLite" />,
    url: 'https://www.sqlite.org',
  },
  {
    title: 'FIRESTORE',
    description: 'Banco NoSQL, offline e sincronização em tempo real',
    icon: <GenericIcon size={size} name="Firestore" />,
